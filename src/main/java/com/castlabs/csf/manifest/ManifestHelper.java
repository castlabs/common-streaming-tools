...
public class ManifestHelper {
    ...
    public static RepresentationType createRepresentation(AdaptationSetType adaptationSet, IsoFile track) {
        ...
        representation.setId(ainf.getApid());
    ...
    private static AudioQuality getAudioQuality(IsoFile track) {
        SampleDescriptionBox stsd = (SampleDescriptionBox) Path.getPath(track, "/moov[0]/trak[0]/mdia[0]/minf[0]/stbl[0]/stsd[0]");

        String type = stsd.getSampleEntry().getType();
        if (type.equals("enca")) {
            OriginalFormatBox frma = stsd.getSampleEntry().getBoxes(OriginalFormatBox.class, true).get(0);
    ...
    private static AudioQuality getDtsAudioQuality(IsoFile track) {
    ...
    private static AudioQuality getAacAudioQuality(IsoFile track) {
        AudioQuality l = new AudioQuality();
        SampleDescriptionBox stsd = (SampleDescriptionBox) Path.getPath(track, "/moov[0]/trak[0]/mdia[0]/minf[0]/stbl[0]/stsd[0]");
        AudioSampleEntry ase = (AudioSampleEntry) stsd.getSampleEntry();
    ...
    private static AudioQuality getAc3AudioQuality(IsoFile track) {
        AudioQuality l = new AudioQuality();
        l.fourCC = "AC-3";
        SampleDescriptionBox stsd = (SampleDescriptionBox) Path.getPath(track, "/moov[0]/trak[0]/mdia[0]/minf[0]/stbl[0]/stsd[0]");
        AudioSampleEntry ase = (AudioSampleEntry) stsd.getSampleEntry();
...
"010010" (18) 640                           "110010" (50) 640
    ...
    private static AudioQuality getEc3AudioQuality(IsoFile track) {
        AudioQuality l = new AudioQuality();
        l.fourCC = "EC-3";
    ...
    private static String getVideoCodecs(IsoFile track) {
